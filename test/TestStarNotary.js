...
*/
/*THIS CODE IS FOR STAR NOTARY PROJECT 2
...
it('lets user2 buy a star and decreases its balance in ether', async() => {
  ...
  */
  ...
  var accounts;
  var owner;
  //SD: Added 2 more variables for testing
  var user1;
  var user2;
  ...
  it('can Create a Star', async() => {
      ...
      assert.equal(await instance.tokenIdToStarInfo.call(tokenId), 'Awesome Star 1')
  });
  ...
  it('can add the star name and star symbol properly', async() => {
      ...
      let instance = await StarNotary.deployed();
      let starId = 6;
      await instance.createStar('awesome star 6', starId, {from: accounts[0]});
      //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided
      assert.equal(await instance.symbol(), 'SYD');
      assert.equal(await instance.name(), 'DecentralizedYellowSun');
  });
  ...
  it('lookUptokenIdToStarInfo test', async() => {
      ...
      let instance = await StarNotary.deployed();
      let starId = 10;
      await instance.createStar('awesome star 10', starId, {from: accounts[0]});
